  ...
  const handleOAuthSignIn = async (provider: 'github' | 'google') => {
    ...
    try {
      ...
      if (provider === 'github') {
        ...
        const googleAuthUrl = `https://accounts.google.com/o/oauth2/v2/auth?client_id=${process.env.NEXT_PUBLIC_GOOGLE_CLIENT_ID}&redirect_uri=${encodeURIComponent('http://localhost:3001/api/auth/callback/google')}&scope=email profile&response_type=code`
  ...
  return (
    <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50">
      <div className="bg-white rounded-lg p-8 max-w-md w-full mx-4">
        ...
        {/* OAuth Buttons - Only show if OAuth is configured */}
